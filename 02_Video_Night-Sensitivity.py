...
if __name__ == "__main__":
    ...
    expected_responses = [
        ["RECEIVE INTERNAL MSG CAROUSEL TASK = 47", "RECEIVE INTERNAL MSG CAROUSEL TASK = 54"],
        ["RECEIVE INTERNAL MSG CAROUSEL TASK = 6", ""],
        ["RECEIVE INTERNAL MSG CAROUSEL TASK = 6", ""],
        ["RECEIVE INTERNAL SYS MENU TASK = 51", "RECEIVE INTERNAL SYS MENU TASK = 58"],
        ["RECEIVE INTERNAL SYS MENU TASK = 4", ""],
        ["RECEIVE INTERNAL SYS MENU TASK = 4", ""],
        ["one = 1 two = 0", ""],
        ["NIGHT MODE SWITCH 1", ""],
        ["Apply choosen resolution in Day Mode: 3", ""],
        ["SCALES TASK RESUMED", ""]
